...
**Live Demos:** [Admin Panel](https://admin.joyminis.com) · [Main App](https://app.joyminis.com) · [Public Blog](https://blog.joyminis.com) · [API Health](https://api.joyminis.com/api/v1/health)
...
graph TB
    subgraph Clients["Clients"]
        ...
        Blog["Public Blog<br/>blog.joyminis.com"]
...
- 📱 **Created** the public blog with Capacitor mobile app ([`blog.joyminis.com`](https://blog.joyminis.com), iOS/Android)
