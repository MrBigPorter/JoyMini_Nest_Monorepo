...
export default function CreateArticlePage() {
  ...
  const { submitHandler, isLoading, errors, watch, setValue } = form;
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        buttonDisabled={isLoading || !watch('title') || !watch('content')}
        ...
        <Form {...form}>
          <form onSubmit={submitHandler} className="space-y-6">
            ...
            <div className="flex items-center justify-end space-x-4 pt-6 border-t">
              ...
              <button
                type="submit"
                disabled={isLoading || !watch('title') || !watch('content')}
