...
console.log(
  `   子评论parentId: ${mockCommentResponse.items[0].children[0].parentId}`,
);
console.log(
  `   类型匹配: ${typeof mockCommentResponse.items[0].id} === ${typeof mockCommentResponse.items[0].children[0].parentId}`,
);
...
console.log(
  `   是否匹配: ${newComment.parentId === mockCommentResponse.items[0].id}`,
);
