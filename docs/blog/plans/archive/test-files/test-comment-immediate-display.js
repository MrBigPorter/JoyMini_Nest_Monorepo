...
// 检查评论加载状态逻辑
const isCommentLoaded = optimisticComment.id && (optimisticComment.approved || !optimisticComment.id.startsWith('temp-'));
console.log('\n2. 评论加载状态检查:');
...
const isReplyLoaded = replyComment.id && (replyComment.approved || !replyComment.id.startsWith('temp-'));
console.log('\n3. 回复评论加载状态检查:');
