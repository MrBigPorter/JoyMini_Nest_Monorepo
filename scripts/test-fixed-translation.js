...
function testFixedTranslationLogic() {
  ...
  console.log(
    "contentMdLocalized:",
    JSON.stringify(updateData.contentMdLocalized),
  );
  ...
  console.log(
    "contentLocalized zh 值:",
    updateData.contentLocalized.zh ? "有值" : "空",
  );
  ...
  const sourceTitle2 =
    getSourceContent("title", "titleLocalized") ||
    articleEmptyTitle.title ||
    "";
  console.log("空标题情况:");
  ...
  console.log(
    "更新后的 titleLocalized:",
    JSON.stringify(updateData2.titleLocalized),
  );
